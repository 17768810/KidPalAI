...
"<input id='base_url' placeholder='https://api.mimi.com'>"
"</div></div>"

/* QQ Bot section */
"<div class='card collapsed' id='sec-qq'>"
"<div class='card-hdr' onclick='toggle(this)'>QQ Bot</div>"
"<div class='card-body'>"
"<label>App ID</label>"
"<input id='qq_app_id' placeholder='123456789'>"
"<label>App Secret</label>"
"<input id='qq_app_secret' type='password' placeholder='App Secret'>"
"<label>Gateway WebSocket URL</label>"
"<input id='qq_gateway_ws_url' placeholder='wss://ws.example.com'>"
"</div></div>"
...
"'feishu_app_id','feishu_app_secret','qq_app_id','qq_app_secret','qq_gateway_ws_url','proxy_host','proxy_port','proxy_type','search_key','tavily_key'];"
"var data={};"
